...
class _ChatDetailsState extends State<ChatDetails> with TickerProviderStateMixin {
              ...
              padding: const EdgeInsets.only(left: 5.0),
                child: new Column(
                  ...
                  children: <Widget>[
                    ...
                    new Text("last seen. 05:00", style: new TextStyle(fontSize: 13.0, color: Colors.white, fontStyle: FontStyle.italic),),
                  ],
                ),
            ),
          ],
        ...
        children: <Widget>[
          ...
          new Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                new Text("Raushan", style: new TextStyle(color: Colors.black, fontSize: 16.0, fontWeight: FontWeight.bold)),
                new Container(
